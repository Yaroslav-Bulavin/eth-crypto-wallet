...
export const CHRABI = [{
  ...
  constant: false, inputs: [{ name: 'to', type: 'bytes32' }, { name: 'value', type: 'uint256' }], name: 'transferToChromia', outputs: [], payable: false, stateMutability: 'nonpayable', type: 'function',
}, {
  ...
  constant: false, inputs: [{ name: 'newMinter', type: 'address' }], name: 'changeMinter', outputs: [], payable: false, stateMutability: 'nonpayable', type: 'function',
}, {
  ...
  constant: false, inputs: [{ name: 'to', type: 'address' }, { name: 'value', type: 'uint256' }, { name: 'refID', type: 'bytes32' }], name: 'transferFromChromia', outputs: [{ name: '', type: 'bool' }], payable: false, stateMutability: 'nonpayable', type: 'function',
}, {
  constant: true, inputs: [{ name: 'owner', type: 'address' }, { name: 'spender', type: 'address' }], name: 'allowance', outputs: [{ name: '', type: 'uint256' }], payable: false, stateMutability: 'view', type: 'function',
}, {
  inputs: [{ name: 'minter', type: 'address' }, { name: 'initialBalance', type: 'uint256' }], payable: false, stateMutability: 'nonpayable', type: 'constructor',
}, {
  anonymous: false, inputs: [{ indexed: true, name: 'account', type: 'address' }], name: 'MinterSet', type: 'event',
}, {
  anonymous: false, inputs: [{ indexed: true, name: 'from', type: 'address' }, { indexed: true, name: 'to', type: 'bytes32' }, { indexed: false, name: 'value', type: 'uint256' }], name: 'TransferToChromia', type: 'event',
}, {
  anonymous: false, inputs: [{ indexed: true, name: 'to', type: 'address' }, { indexed: true, name: 'refID', type: 'bytes32' }, { indexed: false, name: 'value', type: 'uint256' }], name: 'TransferFromChromia', type: 'event',
}, {
